...
public class RecordFragment extends Fragment {
    ...
    private TextView mDisName, mDisPhone, mDisAddress, mDisCode, mEmpty;
    ...
    public View onCreateView(
        ...
        View root = inflater.inflate(R.layout.fragment_manager_record, container, false);
        ...
        mDisCode = root.findViewById(R.id.displayed_code);
    ...
    private void setHeader() {
        mRef.child("hospital").child(mHospital).addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                mDisCode.setText("Join code: " + hospitalModel.join_code);
